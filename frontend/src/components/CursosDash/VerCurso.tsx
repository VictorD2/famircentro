        ...
        <React.Fragment>
            ...
            <div className="contenido-principal p-4">
                <div className="d-flex efecto_titulo">
                    ...
                    <h4 className="text-uppercase">{tipo} {modalidad} {curso.nombre_curso}</h4>
                </div>
                <div className="row mt-4">
                    <div className="col-12 col-sm-6">
                        <img src={fotoSinCurso} className="img-fluid" alt="" />
                    </div>
                    <div className="col-12 col-sm-6">
                        <div className="d-flex align-items-center mb-3">
                            <p className="m-0 card-text fw-bold"><GiTeacher className="mb-1" /> Docente:  </p>
                            <p className="m-0 ms-2 fw-normal">{profesor.nombre} {profesor.apellido}</p>
                        </div>
                        <div className="d-flex align-items-center mb-3">
                            <p className="m-0 card-text fw-bold"><FaDollarSign className="mb-1" /> Precio:  </p>
                            <p className="m-0 ms-2 fw-normal">{curso.precio}</p>
                        </div>
                        {params.modalidad === 'Sincronicos' ? (<>
                            <div className="d-flex align-items-center mb-3">
                                <p className="m-0 card-text fw-bold">Enlace:  </p>
                                <a href={curso.enlace} className="m-0 ms-2 fw-normal text-decoration-none" target="_BLANK" rel="noreferrer" >{curso.enlace}</a>
                            </div>
                            <div className="d-flex align-items-center mb-3">
                                <p className="m-0 card-text fw-bold"><FiClock className="mb-1" /> Duración:  </p>
                                <p className="m-0 ms-2 fw-normal">{curso.duracion} horas</p>
                            </div>
                            <div className="d-flex align-items-center mb-3">
                                <p className="m-0 card-text fw-bold"><FaCalendarAlt className="mb-1" /> Horario: </p>
                    ...
                    {params.modalidad === 'Sincronicos' ? (<>
                        <div className="col-12 col-sm-12 mt-3">
                            ...
                            <table className="table table-light-gray table-bordered table-hover table-responsive mt-3">
                                <thead>
                                    <tr>
                                        <th><FaRegImage /> Foto</th>
                                        <th>Nombre del Estudiante</th>
                                        <th><CgMail /> Correo Electrónico</th>
                                        <th><FaPhoneAlt /> Número de Teléfono</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {estudiantes.length === 0 ? (<>
                                        ...
                                        {estudiantes.map(estudiante => {
                                            return (
                                                <tr>
                                                    <td style={{ width: "100px", height: "100%" }}> <img alt="Foto Perfil" className="img-fluid" src={fotoSinCurso} /></td>
                                                    <td className="py-auto">{estudiante.nombre} {estudiante.apellido}</td>
