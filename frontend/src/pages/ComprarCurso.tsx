                ...
                <div className="row">
                    ...
                    <div className="col-sm-6">
                        ...
                        <form onSubmit={handleFormSubmit} className="mt-2 mb-5 w-100 d-flex align-items-center justify-content-center flex-row">
                            ...
                            <button className="btn btn__blue m-0 d-flex" type="submit"><BiPaperPlane className="mt-1 me-1" /> Enviar</button>
                        </form>
...
const Paso = (props: PropsPaso) => {
    return (
        <div className="w-100 mb-5 px-5 pt-0">
            <h6 className="fw-bold border border-2 border-warning text-center w-50 mx-auto p-2 fs-5" style={{ color: 'var(--amarillo-oscuro)' }} >{props.titulo}</h6>
            <p className="m-0 w-100 text-center fw-bold" style={{ color: 'var(--azul-oscuro)' }}>{props.subtitulo}</p>
    ...
    return (
        <div className="row mt-4" style={{ borderBottom: '1px solid var(--azul-oscuro)' }}>
            <div className="col-6 col-sm-6">
                <p className="m-0 fw-bold text-uppercase" style={{ color: 'var(--azul-oscuro)' }}>{props.titulo1}</p>
                <p className="m-0">{props.subtitulo1}</p>
            </div>
            <div className="col-6 col-sm-6 text-end">
                <p className="m-0 fw-bold text-uppercase" style={{ color: 'var(--azul-oscuro)' }}>{props.titulo2}</p>
